...
public class ManageCustomerJPanel extends javax.swing.JPanel {
    ...
    public void populateTable(){
        ...
        for(UserAccount userAccount:system.getCustomerDirectory().getUserAccountList()){
    ...
    private void createJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createJButtonActionPerformed
        ...
        system.getCustomerDirectory().createUserAccount(username, password, employee, new CustomerRole());
        //restaurant.getUserAccountDirectory().getUserAccountList().add(account);
    ...
    private void viewJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewJButtonActionPerformed
        ...
        int selectedRow = customerJTable.getSelectedRow(), col = 0;
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(this, "Please select at least a row.", "INFORMATION", JOptionPane.ERROR_MESSAGE);
            return;
        }

        Integer userAccountSelectedRow=(Integer) customerJTable.getValueAt(selectedRow, 0);
        UserAccount ua = null;
        for(UserAccount userAccount:system.getCustomerDirectory().getUserAccountList()){
            if(userAccount.getRole().toString().equals("Customer")&&userAccountSelectedRow.equals(userAccount.getEmployee().getId())){
                ua = userAccount;
                break;
            }
        }
        this.userProcessContainer.add("ViewCustomersJPanel",new ViewCustomersJPanel(this.userProcessContainer,this, ua));
    ...
    private void deleteJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteJButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            if (selectionResult == JOptionPane.YES_OPTION) {
                ...
                for(UserAccount userAccount:system.getCustomerDirectory().getUserAccountList()){
                    if(userAccount.getRole().toString().equals("Customer")&&userAccountSelectedRow.equals(userAccount.getEmployee().getId())){
                        system.getCustomerDirectory().getUserAccountList().remove(userAccount);
                        break;
                    }
                }
                populateTable();
