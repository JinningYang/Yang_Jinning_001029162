...
public class ManageDeliveryManJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deliverymen Information");
    ...
    private void createJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createJButtonActionPerformed
        ...
        system.getDeliveryManDirectory().createUserAccount(username, password, employee, new DeliverManRole());
        populateTable();
    ...
    private void viewJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewJButtonActionPerformed
        ...
        int selectedRow = deliverymanJTable.getSelectedRow(), col = 0;
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(this, "Please select at least a row.", "INFORMATION", JOptionPane.ERROR_MESSAGE);
            return;
        }

        Integer userAccountSelectedRow=(Integer) deliverymanJTable.getValueAt(selectedRow, 0);
        UserAccount ua = null;
        for(UserAccount userAccount:system.getDeliveryManDirectory().getUserAccountList()){
            if(userAccount.getRole().toString().equals("Delivery")&&userAccountSelectedRow.equals(userAccount.getEmployee().getId())){
                ua = userAccount;
                break;
            }
        }
        this.userProcessContainer.add("ViewDeliveryManJPanel",new ViewDeliverymanJPanel(this.userProcessContainer,this, ua));
    ...
    private void deleteJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteJButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            if (selectionResult == JOptionPane.YES_OPTION) {
                ...
                for(UserAccount userAccount:system.getDeliveryManDirectory().getUserAccountList()){
                    if(userAccount.getRole().toString().equals("Delivery")&&userAccountSelectedRow.equals(userAccount.getEmployee().getId())){
                        system.getDeliveryManDirectory().getUserAccountList().remove(userAccount);
                        break;
                    }
                }
                populateTable();
