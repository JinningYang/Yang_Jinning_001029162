...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTree(){
       ...
       for(int i=0;i<restaurantList.size();i++){
           ...
           restaurants.add(restaurantNode);
           
           DefaultMutableTreeNode rm = new DefaultMutableTreeNode("Managers");
           restaurantNode.add(rm);
           for(UserAccount ua:restaurant.getUserAccountDirectory().getUserAccountList()){
               System.out.println(ua.getUsername());
               rm.add(new DefaultMutableTreeNode(ua.getUsername()));
           }
       }
       
       DefaultMutableTreeNode dvm = new DefaultMutableTreeNode("Delivery Man");
       root.add(dvm);
       for (UserAccount ua : ecosystem.getDeliveryManDirectory().getUserAccountList()) {
           dvm.add(new DefaultMutableTreeNode(ua.getUsername()));
       }
       
       DefaultMutableTreeNode cus=new DefaultMutableTreeNode("Customer");
       root.add(cus);
       for(UserAccount ua:ecosystem.getCustomerDirectory().getUserAccountList()){
           cus.add(new DefaultMutableTreeNode(ua.getUsername()));
       }
       model.reload();
    }
    /**
    ...
    private void btnManageEnterpriseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageEnterpriseActionPerformed
        ManageRestaurantManaJPanel manageRestaurantManaJPanel=new ManageRestaurantManaJPanel(userProcessContainer, ecosystem);
        userProcessContainer.add("manageRestaurantManaJPanel",manageRestaurantManaJPanel);
        CardLayout layout=(CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
